                    ...
                    <table class="sm-w-full" style="font-family: 'Montserrat',Arial,sans-serif; width: 600px;"
                        ...
                        <tr>
                            <td align="center" class="sm-px-24"
                                style="font-family: 'Montserrat',Arial,sans-serif; background-color: #1C5F7B; border-radius: 20px;">
                                <table style="font-family: 'Montserrat',Arial,sans-serif; width: 100%;"
                                    width="100%; background-color: #1C5F7B; border-radius: 20px;" cellpadding="0"
                                    cellspacing="0" role="presentation">
                                    <tr>
                                        <td class="sm-px-24"
                                            style=" --bg-opacity: 0.3;  background-color: #1C5F7B; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif; font-size: 14px; line-height: 24px; padding-bottom: 40px; padding-top: 20px; border-radius: 20px 20px 0 0; text-align: center;">
                                            <span
                                                style="font-weight: 800; font-size: 32px; line-height: normal; margin-bottom: 0; color: #eceff1;">${CONFIG.appName}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="sm-px-24"
                                            ...
                                            <table cellpadding="0" style="width: 100%;" cellspacing="0"
                                                ...
                                                <tr>
                                                    <td align="center" style="padding: 10px 0;">
                                                        <span
                                                            style="font-size: 32px; margin: 10px 0; padding: 10px 0; font-weight: bolder;">${otp}</span>
                                            ...
                                            <p style="margin: 0 0 16px;">Thanks, <br>The ${CONFIG.appName} Support Team
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
