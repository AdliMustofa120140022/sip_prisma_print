    ...
    <div class=" w-full">
        ...
        <form method="POST" enctype="multipart/form-data" action="{{ route('user.costume.store') }}"
            ...
            <div class="grid grid-cols-3 gap-8 py-2">
                ...
                <div class="col-span-2 space-y-4">
                    <select name="sub_kategori_id" id="sub_katagori"
                        class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 mb-4 ">
            ...
            <div class="grid grid-cols-3 gap-8 py-2">
                ...
                <div class="col-span-2 space-y-4">
                    <input type="number" step="0.01" id="height_gram" name="height_gram"
                        class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 mb-4 "
                        placeholder="Tinggi Produk" value="{{ old('height_gram') }}">
                </div>
            </div>
            @error('height_gram')
                <p class="text-red-500 text-xs">{{ $message }}</p>
            ...
            <div class="grid grid-cols-3 gap-8 py-2">
                ...
                <div class="col-span-2 space-y-4">
                    <input type="text" id="print_resolution" name="print_resolution"
                        class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 mb-4 "
                        placeholder="Resolusi Cetakan" value="{{ old('print_resolution') }}">
                </div>
            </div>
            ...
            <div class="grid grid-cols-3 gap-8 py-2">
                ...
                <div class="col-span-2 space-y-4">
                    <input type="text" id="finishing" name="finishing"
                        class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 mb-4 "
                        placeholder="Finishing" value="{{ old('finishing') }}">
                </div>
            </div>
            @error('finishing')
                <p class="text-red-500 text-xs">{{ $message }}</p>
            ...
            <div class="grid grid-cols-3 gap-8 py-2">
                ...
                <div class="col-span-2 space-y-4">
                    <input type="number" id="order_quantity" name="order_quantity"
                        class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 mb-4 "
                        placeholder="Jumlah Pesanan" value="{{ old('order_quantity') }}">
                </div>
            </div>
            ...
            <div class="grid grid-cols-3 gap-8 py-2">
                ...
                <div class="col-span-2 space-y-4">
                    <input type="date" id="usage_deadline" name="usage_deadline"
                        class="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 mb-4"
                        placeholder="Waktu Penggunaan" value="{{ old('usage_deadline') }}">
                </div>
            </div>
