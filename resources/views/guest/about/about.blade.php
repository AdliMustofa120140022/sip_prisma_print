    ...
    <div class=" w-full">
        ...
        <div class="max-w-5xl mx-auto bg-white p-6 rounded-lg ">
            ...
            <div class="max-w-4xl mx-auto  rounded-lg p-8">
                <h1 class="text-2xl font-bold text-center mb-6 animate__animated animate__fadeInDown">PROFIL PERCETAKAN PRIMA PRINTING</h1>

                <p class="mb-6 text-justify animate__animated animate__fadeInDown">
                ...
                <ol class="list-decimal list-outside li space-y-2 mb-6 ms-4">
                    ...
                    <li class="pl-3">
                        Inovasi Berkelanjutan: Selalu berinovasi dalam teknologi dan layanan untuk memenuhi
                        kebutuhan pasar yang terus berkembang.
                    </li>
                    <li class="pl-3">
                        Layanan Pelanggan Terbaik: Memberikan pelayanan yang responsif dan solusi yang tepat bagi
                        setiap pelanggan.
                    </li>
                    <li class="pl-3">
                        Keberlanjutan: Menerapkan praktik ramah lingkungan dalam setiap proses produksi.
                    </li>
                </ol>
                ...
                <ul class="list-disc list-outside space-y-2 mb-6 ms-4">
                    ...
                    <li class="pl-3">Proses Cepat & Tepat: Komitmen untuk memberikan hasil tepat waktu dengan kualitas
                        terbaik.</li>
                    <li class="pl-3">Kustomisasi Penuh: Fleksibilitas dalam desain dan spesifikasi sesuai kebutuhan
                        pelanggan.</li>
                </ul>
